                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                ...
                                $('#url').val('ViewerJS/#../files/perda/{{ $item->link }}');
                                $('#detailModal').modal('show');
                                " class="btn btn-sm btn-primary" style="width: 100px; margin: 3px">Lihat</button>

                                <a href="files/perda/{{ $item->link }}?download=true" class="btn btn-sm btn-warning" style="width: 100px; margin: 3px">Download</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="">Nomor Peraturan Daerah</label>
